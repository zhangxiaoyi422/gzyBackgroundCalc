"use strict";
// Template version: 1.1.3 see http://vuejs-templates.github.io/webpack for
// documentation.
...
module.exports = {
    ...
    dev: {
        ...
        proxyTable: {
            "/api": {
                //虚拟目录 target: "http://192.168.2.146:8080/enotary", 公证云开发环境
                target: "http://192.168.88.166:9984",
                // 公证云测试环境 target: "http://192.168.2.76:8080/egz-background/", 黄洪宾本地IP target:
                // "http://192.168.2.105:8080/egz-background", target:
                // "http://192.168.2.107:9876", target: "http://192.168.2.107:8080/dzsd",
                changeOrigin: true,
                pathRewrite: {
                    "^/api": "/"
                }
